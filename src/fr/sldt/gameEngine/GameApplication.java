...
import fr.sldt.gameEngine.exception.code.ErrorCode008;
import fr.sldt.gameEngine.ext.EnumOS2;
import fr.sldt.gameEngine.ext.EnumOSMappingHelper;
...
public abstract class GameApplication implements IGame, Runnable {
    ...
    //The font name
    private String fontName = "normal.png";
    ...
    private void init() {
        ...
        fontRenderer = new FontRenderer(renderEngine, "fonts/" + fontName);
