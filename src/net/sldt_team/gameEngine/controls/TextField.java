...
import net.sldt_team.gameEngine.controls.handler.TextFieldFocusHandler;
import net.sldt_team.gameEngine.controls.handler.TextFieldHandler;
...
public class TextField implements GameComponent {
    ...
    public void renderComponent(RenderEngine renderEngine, FontRenderer fontRenderer) {
        if (hasFocus) {
            renderEngine.bindColor(new ColorRenderer(255, 255, 0));
        } else {
